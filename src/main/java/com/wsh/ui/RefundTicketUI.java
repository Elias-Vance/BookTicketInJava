...
public class RefundTicketUI {
    ...
    public void init() {
        // 创建主窗口
        javax.swing.JFrame frame = new javax.swing.JFrame("退票窗口");
        ...
        refundButton.addActionListener(e -> {
            ...
            if (selectedRow >= 0) {
                ...
                int confirm = JOptionPane.showConfirmDialog(
                        frame,
                        "确定要退票 " + trainNumber + " 次列车从 " + startStation + " 到 " + endStation + " 的票吗？",
                        "确认退票",
                ...
                JOptionPane.showMessageDialog(frame, "退票成功");
            } else {
                JOptionPane.showMessageDialog(frame, "请先选择要退票的车票");
            }
        });
